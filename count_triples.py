...
def count_triples(transform, train_set, valid_set=None, test_set=None):
    ...
    print(f"Average number of triples per molecule: {avg_triples:.2f} (micro avg: {np.mean(micro_avg):.2f})")
    ...
    for transform_name in TRANSFORMS:
        for dataset_name in DATASETS:
            ...
            try:
                ...
                print(f"Error processing {dataset_name} with {transform_name}: {str(e)}")
