...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--poly_method', 
        type=str,
        help='Polynomial method to use'
    )
    parser.add_argument(
        '--poly_dim', 
        type=int,
        help='Polynomial dimension'
    )
    parser.add_argument(
        '--layers', 
        type=int,
...
def split_dataset(dataset, test_ratio: float = TEST_SPLIT_RATIO, 
...
def train_single_target(target: int, dataset, cfg, timestamp: str, 
                       results_allruns: dict):
