...
class CatMLP_Layer(nn.Module):
    ...
    def __init__(self, mlp_depth: int, hidden_dim: int, use_sqrt: bool, drop_prob: float):
        ...
        self.mlp1 = self._create_mlp_block(mlp_depth, hidden_dim * 2, hidden_dim, drop_prob)
...
class CatMLP_2FWLGNN(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.layers = nn.ModuleList([
            CatMLP_Layer(self.mlp_depth, self.hidden_dim, self.use_sqrt, self.drop_prob)
